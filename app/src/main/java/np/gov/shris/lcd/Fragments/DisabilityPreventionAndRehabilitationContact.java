...
public class DisabilityPreventionAndRehabilitationContact extends Fragment {

    public DisabilityPreventionAndRehabilitationContact() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        name.setText(AppConstants.disabilityPreventionAndRehabilitationContactName);
        designation.setText(AppConstants.disabilityPreventionAndRehabilitationContactDesignation);
        email.setText(AppConstants.disabilityPreventionAndRehabilitationContactEmail);
        Picasso.with(getContext())
                .load(R.drawable.mahesh_kumar_puri)
                ...
                if(event.getAction() == 0) {
                    if(event.getRawX() >= (email.getRight() - email.getCompoundDrawables()
                        ...
                        emailIntent.putExtra(Intent.EXTRA_EMAIL, new String[]
                                {AppConstants.disabilityPreventionAndRehabilitationContactEmail});
            ...
            public boolean onTouch(View view, MotionEvent event) {
                ...
                if(event.getAction() == 0 ) {
                    if(event.getRawX() >= (name.getRight() - name.getCompoundDrawables()
                            [DRAWABLE_RIGHT].getBounds().width())) {
                        final String[] phoneList = AppConstants.disabilityPreventionAndRehabilitationContactPhoneList;
