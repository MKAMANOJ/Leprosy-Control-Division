...
public class LeprosyEffectsDeformities extends Fragment {

    TextView cbimci_info;

    public LeprosyEffectsDeformities() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView.loadUrl("file:///android_asset/leprosy_effects_deformities.html");
