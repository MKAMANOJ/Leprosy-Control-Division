...
public class LeprosyEffectsCommonlyEffected extends Fragment {



    public LeprosyEffectsCommonlyEffected() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView.loadUrl("file:///android_asset/leprosy_effects_commonly_affected.html");
        return rootview;
    }
