...
import np.gov.shris.lcd.Adapters.IntroductionCategoryAdapter;
...
public class IntroductionActivity extends AppCompatActivity
    ...
    public void initActivity() {
        ...
        setTitle(R.string.main_introduction);
        ...
        IntroductionCategoryAdapter adapter = new IntroductionCategoryAdapter(getSupportFragmentManager());
