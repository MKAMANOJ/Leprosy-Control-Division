...
public class Leprosy_Control_Objectives extends Fragment {

    public Leprosy_Control_Objectives() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        webView.loadUrl("file:///android_asset/leprosy_control_objectives.html");
