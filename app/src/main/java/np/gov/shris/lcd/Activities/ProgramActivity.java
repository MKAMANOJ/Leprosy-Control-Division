...
import np.gov.shris.lcd.Adapters.ProgramsAdapter;
...
public class ProgramActivity extends AppCompatActivity
    ...
    public void initActivity() {
        ...
        setTitle(R.string.main_programs);
        ...
        listView = (ListView) findViewById(R.id.programs_listView);
        generateData();

        ProgramsAdapter programsAdapter = new ProgramsAdapter(ProgramActivity.this, 0, programItems);
        listView.setAdapter(programsAdapter);
        programsAdapter.notifyDataSetChanged();

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = position == 0 ?
                        new Intent(ProgramActivity.this,LeprosyControlActivity.class):
                        new Intent(ProgramActivity.this,DisabilityPreventionAndRehabilitationActivity.class);
    ...
    private void generateData() {
        ...
        programItems.add(new ProgramItem("1. Leprosy Control"));
        programItems.add(new ProgramItem("2. Disability Prevention and Rehabilitation"));
